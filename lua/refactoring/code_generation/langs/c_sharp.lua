...
local function c_sharp_func_args_default_types(args)
    local new_args = {}
...
local function c_sharp_func_args_with_types(args, args_types)
...
local function c_sharp_func_args(opts)
    if opts.args_types ~= nil then
        return c_sharp_func_args_with_types(opts.args, opts.args_types)
    else
        return table.concat(c_sharp_func_args_default_types(opts.args), ", ")
    end
end

local function c_sharp_constant(opts)
